document.addEventListener('DOMContentLoaded', function() {
    ...
    function showModal(result, type) {
        ...
        document.getElementById('result-strengths').textContent = `強み: ${result.strengths}`;
        document.getElementById('result-challenges').textContent = `課題: ${result.challenges}`;
        document.getElementById('result-keywords').textContent = `キーワード: ${result.keywords}`;
