document.addEventListener('DOMContentLoaded', function() {
    ...
    const diagnosisResults = {
        "A型×火属性": {
            title: "内に秘めた情熱を燃やす<br>誠実なチャレンジャー",
            description: "普段はA型らしく、周囲への配慮を欠かさない温厚な常識人。しかしその内側には、まるで静かな炎のように「これだけは譲れない」という強い信念や理想を秘めています。A型の計画性と火の直感が組み合わさることで、情熱的でありながらも無謀ではない、頼れるリーダーになる資質を持っています。",
            ...
            keywords: "誠実/情熱家/努力家<br>正義感/リーダーシップ"
        },
        "A型×地属性": {
            title: "揺るぎない安定感を誇る<br>完璧主義な努力家",
            description: "「堅実」という言葉が最も似合うタイプで、安定と秩序を何よりも重んじます。A型の几帳面さと「地」の現実的な感覚が合わさり、何事も計画的に、そして着実にこなしていきます。派手さはありませんが、その確実な仕事ぶりと責任感の強さは、周囲から絶大な信頼を得ているはずです。自分の中に確固たる「美学」やルールがあり、それを静かに貫く強さを持っています。",
            strengths: "どんな時もブレない抜群の安定感と信頼性。<br>細部にまでこだわる完璧主義。<br>目標に向かってコツコツ努力できる<br>忍耐力。",
            challenges: "慎重すぎるあまり、チャンスを逃すことがある。自分にも他人にも完璧を求めすぎてしまい、少し厳しくなりがち。融通が利かない一面も。",
            keywords: "堅実/真面目/信頼<br>完璧主義/安定志向"
        },
        "A型×風属性": {
            title: "知性と気配りを兼ね備えた<br>スマートな社交家",
            description: "A型の持つ協調性に、「風」の持つ優れたコミュニケーション能力と知性が加わります。そのため、誰とでもそつなく付き合える高い社交性を持ち、場の空気を読んで立ち回るのが非常に得意です。しかし、そのにこやかな表情の裏では常に冷静に状況を分析しており、一人の時間で思考を整理することも大切にしているはずです。",
            ...
            keywords: "社交的/知的/気配り<br>バランス感覚/調整役"
        },
        "A型×水属性": {
            title: "深い愛情と共感力を持つ<br>繊細なサポーター",
            ...
            keywords: "優しさ/共感/献身<br>繊細/愛情深い"
        },
        "B型×火属性": {
            title: "好奇心の赴くまま突き進む<br>最強の自由人",
            ...
            keywords: "自由奔放/チャレンジャー<br>情熱的/正直/個性的"
        },
        "B型×地属性": {
            title: "好きな道を究める<br>こだわりの職人",
            ...
            keywords: "職人気質/マイペース<br>こだわり/探求心/粘り強さ"
        },
        "B型×風属性": {
            title: "軽やかに時代を遊ぶ<br>ユニークなアイデアマン",
            ...
            keywords: "アイデアマン/好奇心旺盛<br>ユニーク/自由人/個性的"
        },
        "B型×水属性": {
            title: "独特の世界観を持つ<br>感性のアーティスト",
            description: "B型の個性的な感性と、「水」の豊かな感受性が融合し、独特の「不思議」なオーラを放つタイプです。夢やロマンを大切にし、直感やインスピレーションに従って生きています。感情表現は豊かですが、その世界観は独特なため、周りからはミステリアスに映ることも。意志が強く、意外な頑固さも持ち合わせています。",
            strengths: "豊かな感受性と独創的な世界観。直感力に優れる。愛情深く、一度心を許した相手にはとことん尽くす。",
            challenges: "気分屋で感情の波が激しい。現実離れした理想を追い求めがち。自分の世界に閉じこもることがある。",
            keywords: "アーティスト/不思議な魅力<br>感受性/ロマンチスト/直感的"
        },
        "O型×火属性": {
            title: "人々を惹きつけてやまない<br>生まれながらのリーダー",
            description: "O型の持つ大らかなリーダーシップと、「火」のエレメントの持つ情熱・カリスマ性が合わさり、最もパワフルで存在感のあるタイプとなります。 常に前向きでエネルギッシュ。目標に向かって突き進む姿は、自然と周りに人を集めます。細かいことは気にしないカラッとした明るさと、面倒見の良さで多くの人に慕われるでしょう。",
            strengths: "圧倒的なリーダーシップとカリスマ性。ポジティブでエネルギッシュ。面倒見が良く、仲間思い。",
            challenges: "時に強引で自己中心的になりがち。大雑把で、細かい配慮に欠けることがある。負けず嫌いが過ぎることも。",
            keywords: "カリスマ/リーダー/情熱的<br>親分肌/エネルギッシュ"
        },
        "O型×地属性": {
            title: "信頼と実績を築き上げる<br>温厚な実力者",
            description: "O型の目標達成意欲が、地のエレメントの堅実さと結びつき、「有言実行」を体現する人。どっしりと落ち着いた雰囲気を持ち、包容力のある頼れる存在となります。理想を語るだけでなく、それを現実に落とし込むための地道な努力を惜しみません。組織のトップとして、部下を守り育てるような立場に向いています。",
            strengths: "包容力と安定感。現実的な視点で物事を判断できる落ち着き。目標を現実に変える実行力と忍耐力。人望が厚く、信頼される。",
            challenges: "保守的で、新しい変化を受け入れるのに時間がかかる。頑固で、一度決めたことはなかなか曲げない。",
            keywords: "包容力/安定感<br>実力者/信頼/現実的"
        },
        "O型×風属性": {
            title: "ユーモアと広い人脈を持つ<br>華やかな社交家",
            description: "O型の社交性に、「風」の持つコミュニケーション能力と軽やかさが加わった、天性の人気者。人を楽しませることが好きで、ユーモアを交えた会話で場の空気を明るくするのが得意です。 幅広い人脈を持ち、様々な情報を集めては、それを周りのために活かすことができます。平和主義者で、人と人との調和を大切にします。",
            strengths: "抜群の社交性とコミュニケーション能力。ユーモアのセンスとサービス精神。広い人脈と情報網。",
            challenges: "時に調子が良すぎると見られることがある。深い話や深刻な雰囲気が苦手。広く浅い付き合いになりがち。",
            keywords: "社交家/人気者/ユーモア<br>平和主義/情報通"
        },
        "O型×水属性": {
            title: "仲間を全力で守り抜く<br>情に厚い人情家",
            ...
            strengths: "人情に厚く、面倒見が良い。仲間を大切にする強い絆。人間味あふれる温かさ。豊かな感受性と共感力。",
            challenges: "仲間びいきが強く、敵と味方をはっきり分けがち。感情的になりやすく、時に独占欲が強くなる。",
            keywords: "人情家/仲間思い/ピュア<br>愛情深い/面倒見が良い"
        },
        "AB型×火属性": {
            title: "冷静な頭脳と情熱を併せ持つ<br>クールな戦略家",
            ...
            keywords: "戦略家/クール/野心家<br>合理的/ギャップ"
        },
        "AB型×地属性": {
            title: "無駄を嫌う<br>孤高のプロフェッショナル",
            ...
            keywords: "プロフェッショナル<br>ミステリアス<br>合理的/実務家/冷静沈着"
        },
        "AB型×風属性": {
            title: "時代を先読みする<br>知的な観察者",
            description: "AB型の分析力と、「風」の知性が最もシャープに現れる組み合わせです。頭の回転が非常に速く、物事の本質を瞬時に見抜くことができます。誰に対しても平等で博愛的な精神を持ちますが、心の内側には決して踏み込ませない、見えない壁を持っています。常識にとらわれない個性的な生き方をすることが多いでしょう。",
            strengths: "鋭い分析力と先見の明。極めて知的で論理的。公平で、偏見を持たない。",
            challenges: "理屈っぽく、皮肉屋に見られがち。他人に心を開かず、孤立することがある。行動よりも批評が先行することも。",
            keywords: "天才肌/知的/分析家<br>クール/博愛主義"
        },
        "AB型×水属性": {
            title: "鋭い洞察力を持つ<br>不思議な癒し手",
            description: "AB型の持つクールな観察眼と、「水」の持つ共感力という、一見矛盾した性質が同居する、最もミステリアスなタイプです。人の心を鋭く見抜く洞察力を持ちながらも、それに深入りすることはなく、独特の距離感で相手に寄り添う不思議な優しさの持ち主です。繊細で優しいですが、その本心は誰にも見せません。",
            ...
            keywords: "不思議な魅力/ミステリアス<br>洞察力/癒し手/繊細"
        }
    };
    ...
    function showModal(result, type) {
        ...
        resultTypeElement.textContent = type; // まずテキストを設定
    ...
    function displayRandomBackgroundImages() {
        ...
        const fixedImagePlacements = [
            { imageUrl: 'images/01_A-Fire/result.png', top: '-5%', left: '10%', scale: 0.7 },
            { imageUrl: 'images/01_A-Fire/result.png', top: '-9%', right: '19%', scale: 0.5 },
            { imageUrl: 'images/05_B-Fire/result.png', top: '25%', right: '3%', scale: 0.8 },
            { imageUrl: 'images/09_O-Fire/result.png', bottom: '0%', left: '16%', scale: 1.0 },
            { imageUrl: 'images/13_AB-Fire/result.png', bottom: '-13%', right: '9%', scale: 0.7 },
            { imageUrl: 'images/03_A-Air/result.png', top: '50%', left: '-2%', transform: 'translateY(-50%)', scale: 0.6 }, // 垂直中央
            { imageUrl: '', top: '0%', left: '30%', scale: 0.7 },
            { imageUrl: '', bottom: '15%', right: '25%', scale: 0.9 }
        ];
